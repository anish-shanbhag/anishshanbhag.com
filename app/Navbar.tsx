...
export default function Navbar() {
  ...
  return (
    <div
      className={`flex justify-center sticky z-[600] transition-all duration-500 ${
    ...
    >
      <nav className="flex justify-between items-center max-w-[70rem] w-full mx-4 xs:mx-12 sm:mx-20 md:mx-32 h-16 bg-white rounded-full bg-opacity-50 backdrop-blur-sm shadow-2xl">
        <div
          className="flex justify-center items-center w-16 h-16 bg-blue-500 cursor-pointer hover:scale-[118%] transition-all duration-300 rounded-full shadow-[rgba(0,_0,_0,_0.2)_0px_12px_38px,_rgba(0,_0,_0,_0.2)_0px_8px_12px]"
          onClick={() =>
            window.scrollTo({
              top: 0,
              behavior: "smooth",
        ...
        >
          <GradientText
            text="🛆"
            className="relative bottom-[3.5px] right-1 text-[2.5rem] font-black -tracking-wider select-none"
            rounded
          />
        </div>
