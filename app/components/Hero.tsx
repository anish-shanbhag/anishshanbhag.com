...
export default function Hero() {
  ...
  return (
    <MouseParallaxContainer>
      <div className="absolute top-0 justify-center items-center w-screen h-80 oveflow-visible hidden min-[1200px]:flex">
        <MouseParallaxChild factorX={-0.02} factorY={0.05}>
          <Image
            ...
            priority
            alt=""
            className="relative left-[52rem] opacity-70 w-48 overflow-visible"
          />
        </MouseParallaxChild>
        <MouseParallaxChild factorX={0.02} factorY={-0.05}>
          <Image
            ...
            priority
            alt=""
            className="relative left-[-10rem] top-[15rem] opacity-70 w-40 object-cover overflow-visible"
          />
        </MouseParallaxChild>
        <MouseParallaxChild factorX={0.02} factorY={0.05}>
          <Image
            ...
            priority
            alt=""
            className="relative right-[29rem] top-[2rem] opacity-70 w-60 overflow-visible"
          />
        </MouseParallaxChild>
        <MouseParallaxChild factorX={-0.02} factorY={-0.05}>
          <Image
            ...
            priority
            alt=""
            className="relative right-[50rem] top-[11rem] opacity-70 w-60 overflow-visible"
          />
        </MouseParallaxChild>
        <MouseParallaxChild factorX={0.08} factorY={-0.05}>
          <Image
            ...
            priority
            alt=""
            className="relative left-[4rem] top-[13rem] opacity-70 w-60 overflow-visible"
          />
        </MouseParallaxChild>
      </div>
